...
public class JokeController {
    ...
    @Operation(summary = "Get a number of jokes by category", description = "JSON format documented here: https://v2.jokeapi.dev/#examples")
    @GetMapping("/get")
    public ResponseEntity<String> getJokes(
        ...
        @Parameter(name="numJokes", description="number of jokes", example="2") @RequestParam int numJokes
